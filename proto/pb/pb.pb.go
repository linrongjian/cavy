...
type HttpReply struct {
	...
	Errcode int32  `protobuf:"varint,1,opt,name=errcode,proto3" json:"errcode,omitempty"` // 结果码 - 0:成功 other:失败
	Msg     string `protobuf:"bytes,2,opt,name=msg,proto3" json:"msg,omitempty"`          // 错误信息 - 失败时读取
	Data    []byte `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`        // 消息包体 - 成功时读取
}
...
func (x *HttpReply) GetErrcode() int32 {
	if x != nil {
		return x.Errcode
	}
	return 0
...
var file_pb_proto_rawDesc = []byte{
	0x0a, 0x08, 0x70, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x4b,
	0x0a, 0x09, 0x48, 0x74, 0x74, 0x70, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x65,
	0x72, 0x72, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x65, 0x72,
	0x72, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x6d, 0x73, 0x67, 0x18, 0x02, 0x20, 0x01,
