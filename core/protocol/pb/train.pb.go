...
type Player struct {
	...
	MaxGameLevel *uint32 `protobuf:"varint,1,opt,name=maxGameLevel" json:"maxGameLevel,omitempty"` // 最大等级
}
...
func (x *Player) GetMaxGameLevel() uint32 {
	if x != nil && x.MaxGameLevel != nil {
		return *x.MaxGameLevel
	}
	return 0
}
...
var file_train_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x74, 0x72, 0x61, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2c, 0x0a,
	0x06, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x12, 0x22, 0x0a, 0x0c, 0x6d, 0x61, 0x78, 0x47, 0x61,
	0x6d, 0x65, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x6d,
	0x61, 0x78, 0x47, 0x61, 0x6d, 0x65, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x42, 0x07, 0x5a, 0x05, 0x2e,
	0x2e, 0x2f, 0x70, 0x62,
}
...
var file_train_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
